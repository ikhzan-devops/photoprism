...
var SessionFixtures = SessionMap{
	...
	"bob": {
		...
		LoginAt:     Now().Add(time.Microsecond * -24),
		CreatedAt:   Now().Add(time.Microsecond * -24),
		UpdatedAt:   Now().Add(time.Microsecond * -24),
	},
	"unauthorized": {
	...
	"friend": {
		...
		LoginAt:     Now().Add(time.Microsecond * -12),
		CreatedAt:   Now().Add(time.Microsecond * -20),
		UpdatedAt:   Now().Add(time.Microsecond * -12),
	},
	"client_metrics": {
