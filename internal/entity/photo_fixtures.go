...
var PhotoFixtures = PhotoMap{
	...
	"Photo56": { //JPG
		...
		Files: []File{},
		Labels: []PhotoLabel{
			LabelFixtures.PhotoLabel(1000057, "flower", 38, "image"),
			LabelFixtures.PhotoLabel(1000057, "cake", 38, "manual"),
		},
		CreatedAt:  time.Date(2025, 1, 1, 0, 0, 0, 0, time.UTC),
		UpdatedAt:  time.Date(2025, 1, 5, 0, 0, 0, 0, time.UTC),
		EditedAt:   nil,
	...
	"Photo57": { //JPG
		...
		Files: []File{},
		Labels: []PhotoLabel{
			LabelFixtures.PhotoLabel(1000058, "flower", 38, "image"),
			LabelFixtures.PhotoLabel(1000058, "cake", 38, "manual"),
		},
		CreatedAt:  time.Date(2025, 1, 1, 0, 0, 0, 0, time.UTC),
		UpdatedAt:  time.Date(2025, 1, 5, 0, 0, 0, 0, time.UTC),
		EditedAt:   nil,
	...
	"Photo58": { //JPG + MP4
		...
		Files: []File{},
		Labels: []PhotoLabel{
			LabelFixtures.PhotoLabel(1000059, "&friendship", 38, "image"),
			LabelFixtures.PhotoLabel(1000059, "cake", 38, "manual"),
		},
		CreatedAt:  time.Date(2025, 1, 1, 0, 0, 0, 0, time.UTC),
		UpdatedAt:  time.Date(2025, 1, 5, 0, 0, 0, 0, time.UTC),
		EditedAt:   nil,
