...
func TestConvertToPhotoForm_UpdateTitleCaptionTypeAndBooleans(t *testing.T) {
	photo := &entity.Photo{
...
func TestConvertToPhotoForm_UpdateLocationSetsPlaceSrc(t *testing.T) {
	photo := &entity.Photo{}
...
func TestConvertToPhotoForm_UpdateDetails(t *testing.T) {
	photo := &entity.Photo{}
