...
* Your pictures are [automatically labeled](https://try.photoprism.app/library/labels) based on content and location
* [Live Photos](https://try.photoprism.app/library/live) start playing when you hover over them in [search results](https://try.photoprism.app/library/browse?view=cards&q=type%3Alive) and when viewing a slideshow
